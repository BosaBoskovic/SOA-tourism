...
// Duplicated from tours/messaging rather than shared - this repo has no
// shared Go module between services, and every service already
// duplicates its own infra code (observability.go, etc.) the same way.
